...
confirm_box (void)
{
    ...
    QuickWidget conf_widgets[] = {
        ...
        /* 2 */ QUICK_CHECKBOX (3, dlg_width, 7, dlg_height,
        ...
        /* 4 */ QUICK_CHECKBOX (3, dlg_width, 5, dlg_height, N_(" confirm e&Xecute "),
                                &confirm_execute),
        /* 5 */ QUICK_CHECKBOX (3, dlg_width, 4, dlg_height, N_(" confirm o&Verwrite "),
                                &confirm_overwrite),
        /* 6 */ QUICK_CHECKBOX (3, dlg_width, 3, dlg_height, N_(" confirm &Delete "),
                                &confirm_delete),
        QUICK_END
    };
