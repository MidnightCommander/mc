...
struct vfs_s_subclass
{
    ...
    int (*open_archive) (struct vfs_s_super *psup, const vfs_path_t *vpath,
    ...
    struct vfs_s_entry *(*find_entry) (struct vfs_class *me, struct vfs_s_inode *root,
...
/* entries and inodes */
struct vfs_s_inode *vfs_s_new_inode (struct vfs_class *me, struct vfs_s_super *super,
...
struct vfs_s_inode *vfs_s_find_inode (struct vfs_class *me, const struct vfs_s_super *super,
                                      const char *path, int follow, int flags);
