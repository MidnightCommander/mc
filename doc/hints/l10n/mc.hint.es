...
Ayudita: El sitio oficial del Midnight Commander es
...
Ayudita: ¡El mejor VFS! Al E<lt>entrarE<gt> en un archivo comprimido se ve
su contenido.

Ayudita: El Midnight Commander tiene manual: "man mc"

Ayudita: ¿Desea navegar con las flechas al estilo lynx? Está en
Configuración.
...
Ayudita: El formato del listado se puede personalizar; "man mc" para ver
pistas.
...
Ayudita: Puede "Llevar al panel" los resultados de "Buscar archivos" y
usarlos.
...
Ayudita: F13 (o Mayúsculas-F3) invoca el visor en modo primitivo, sin
formatos.

Ayudita: F4 puede usar cualquier editor que indiquemos en la variable
EDITOR.

Ayudita: Se puede usar un visor externo indicado en la variable PAGER.

Ayudita: Para deshabilitar los mensajes de Confirmación vaya al menú
Opciones.
...
Ayudita: Para examinar un archivo RPM basta pulsar E<lt>introE<gt> sobre él.

Hint: To mark directories on the select dialog box, append a slash.

Ayudita: Para copiar y pegar con ratón mantener presionada la tecla
MAYÚSCULAS.
