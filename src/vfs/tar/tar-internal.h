...
struct tar_stat_info
{
    ...
    off_t archive_file_size;    // size of file as stored in the archive, equals stat.st_size for non-sparse files
    ...
    gboolean sparse_name_done;  // TRUE if 'GNU.sparse.name' header was processed pax header parsing. Following 'path'  header (lower priority) will be ignored.
