...
edit_options_dialog (WEdit * edit)
{
    ...
    QuickWidget quick_widgets[] = {
        ...
        /*  2 */ QUICK_LABEL (OPT_DLG_W / 2 + 1, OPT_DLG_W, 14, OPT_DLG_H,
                              N_("Word wrap line length:")),
        /*  3 */ QUICK_INPUT (OPT_DLG_W / 2 + 25, OPT_DLG_W, 14, OPT_DLG_H,
        ...
        /* 13 */ QUICK_LABEL (3, OPT_DLG_W, 14, OPT_DLG_H, N_("Tab spacing:")),
        /* 14 */ QUICK_INPUT (3 + 24, OPT_DLG_W, 14, OPT_DLG_H,
