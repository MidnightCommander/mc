Midnight Commander (c) 1995-1999 Фонд свободного программного обеспечения.
...
Совет: M-! позволит вам выполнять программы и видеть вывод в просмотщике.
...
Совет: Вы сможете видеть резервные файлы .~, установив опцию в меню Конфигурация.
Совет: Имеете много ОЗУ/Вирт.ОЗУ? Установите ограничение памяти ВФС tar в -1.
...
Совет: Некоторые клавиши не работают? Взгляните в Настройки/Распознавание клавиш.
...
Совет: Не работают клавиши в xterms? Попробуйте наши файлы xterm.ad,.ti и .tcap.
Совет: Вы можете выбрать редактор для F4 с помощью переменной оболочки EDITOR.
Совет: Вы можете выбрать внешний просмотрщик с помощью переменной оболочки PAGER.
